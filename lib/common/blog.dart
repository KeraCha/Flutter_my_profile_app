    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: NestedScrollView(
            ...
            return <Widget>[
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: Image.asset("assets/blog.jpg",
          ...
          //QuerySnapshot is the object we receive from Firestore
          body: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                return Center(
                  //CircularProgressIndicator used whilst loading, ensures the user that something is there to read
...
class _BlogPostState extends State<BlogPost> {
  //for expanding and shrinking text of each article
  bool expand = false;
  @override
  Widget build(BuildContext context) {
    return Padding(
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                    onPressed: () {
                      setState(() {
                        //if is false, will set it to true and vice versa
                        expand = !expand;
                      });
                    },
